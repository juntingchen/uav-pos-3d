function f = getcostf2DK_sf(PosUAV, PosUE, PosBS, los, U, fun, sf)
% Version _sf: shadowing noise (variable 'sf')is added to the channel quality
%     Date: March 6th, 2020.
%
...
% NOTE: Assume user height = 0.
    ...
    lopt = lmin;
    f = fl(lopt, rho, theta, L, h, Hb, U, fun, los, sf);

end

function f = fl(l, rho, theta, L, h, Hb, U, fun, los, sf)
    ...
    du2u = l;
    gainu = 10 ^ ((U.Alpha(k) * log10(du2u) + U.Beta(k) + sf) / 10) / U.Noise;
